...
return Promise.reject(error.message || error)
    ...
    getAll():Promise<any> {
    let url = `${this.basePath}/api/slides`
    ...
    let url = `${this.basePath}/api/filter/0/slides/${id}?filter=usuario`
      return this.http.get(url)
                      .toPromise()
                        .then(response => {
                          //console.log(response)
    ...
    let url = `${this.basePath}/api/filter/${data.id}/slides/${data.state}${filter}`
      return this.http.get(url)
                      .toPromise()
                        .then(response => {
                          //console.log(response)
    ...
    let url = `${this.basePath}/api/slides/${id}`
    ...
    let url = `${this.basePath}/api/slides/${form.id}`
