...
return Promise.reject(error.message || error)
    ...
    getAll():Promise<any> {
    let url = `${this.basePath}/api/presentaciones`
    ...
    let url = `${this.basePath}/api/filter/0/presentaciones/${id}?filter=usuario`
      return this.http.get(url)
                      .toPromise()
                        .then(response => {
                          //console.log(response)
    ...
    let url = `${this.basePath}/api/filter/${data.id}/presentaciones/${data.state}${filter}`
      return this.http.get(url)
                      .toPromise()
                        .then(response => {
                          //console.log(response)
    ...
    let url = `${this.basePath}/api/presentaciones/${id}`
    ...
    let url = `${this.basePath}/api/presentaciones/${form.id}`
